	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Festival Areas</h2>
			</div>
			...
			<section id="basic-form-layouts">
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Areas</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" action="area_insert.php" methord="post">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Area</label>
													<input type="text" id="" class="form-control" placeholder="Area" name="area" autocomplete="off">
													</div>
												</div>
												<div class="col-md-12">
												<div class="form-group">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">View Areas</h4>
													...
													if($result->num_rows>0)
														...
														<thead>
															<tr role='row'>
																...
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 263px;'>Area</th>
														...
														<tbody>
															...
															<td class='sorting_1'>".$row['id']."</td>
																<td class='sorting_1'>".$row['area']."</td>
																...
																<a href='catdelete.php?id=".$row['id']."' onclick='return confirm('Are you sure want to delete this post?')''><span style='color:#fff;' class='btn btn-danger glyphicon glyphicon-trash' title='Delete post'>
