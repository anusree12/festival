		...
		<div class="navbar-wrapper">
			<div class="navbar-header">
				<ul class="nav navbar-nav">
					...
					<img alt="branding logo" src="assets/images/logo1.png" data-expand="assets/images/logo1.png" data-collapse="assets/images/coll.png" class="brand-logo">
					</a>
					</li>
	...
	<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
		...
		<div class="main-menu-content">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				...
				<li class=" nav-item"><a href="view.php"><i class="icon-file-text"></i><span data-i18n="nav.bootstrap_tables.table_basic" class="menu-title">View Student</span></a>
				</li>

				<li class=" nav-item"><a href="search.php"><i class="icon-sphere"></i><span data-i18n="nav.icons.main" class="menu-title">Search Student</span></a>
				</li>
	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">View Registration</h2>
			</div>
									...
									<div id="datatables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
											<div class="row">
												<div class="col-sm-12" style="overflow-x: auto;">
													...
													include("tnmdbconnect_admin.php");
													$sql="SELECT * FROM tnm_tb";
													...
													if($result->num_rows>0)
														...
														<thead>
															<tr role='row'>
															<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Admission Number</th>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;'>Name of Student</th>
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 263px;'>Course</th>
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Office: activate to sort column ascending' style='width: 129px;'>Phone Number</th>
														...
														<tbody>
															...
															<td class='sorting_1'>".$row['ad_no']."</td>
...
<p class="clearfix text-muted text-sm-center mb-0 px-2">
	<span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2019 <a href="" target="_blank" class="text-bold-700 black footer_logo">TNM ACADEMY | All rights reserved. </span>
...
function validate()
{
if( document.form.empid.value == "" ||
           isNaN(document.form.empid.value) ||
           document.form.empid.value.length =="" )
   {
     ...
     var lenth=5;
     if(form.empid.value.length < lenth )
     {
      alert("Please Enter Five Digit ID ");
      form.empid.focus();
      return false;
    }
    var lenth=5;
    if(form.empid.value.length > lenth)
    {
      alert("Please Enter Only Five Digit ID");
      form.empid.focus();
      return false;
...
if( form.empname.value == "" )
   ...
   var alpha=/[a-zA-Z]+$/;
   if(alpha.test(form.empname.value)==false)
   {
    alert("Name Should Be contain characters only");
    form.empname.focus();
    return false;
   }
...
if ( ( form.gender[0].checked == false ) && ( form.gender[1].checked == false ) )
 ...
 if (email == "" || atpos < 1 || ( dotpos - atpos < 2 )) 
 {
  ...
  if(form.username.value=="")
  {
    ...
    {
   alert("Username must contain alphabets and numbers only");
   form.username.focus();
   return false;
    }
      var mi = 6;
    var max = 16;
    if(form.username.value.length < mi || form.username.value.length > max )
   {

     alert( "Username should not be empty /  length be between "+mi+" to "+max);
       form.username.focus();
     return false;
   }
...
if(pass.length < mi || pass.length > max )
   {

     alert( "Password should not be empty /  length be between "+mi+" to "+max);
     form.password.focus() ;
     return false;
   }
   var a=/(?=.*[a-z])(?=.*\d)(?=.*[#$^+=!*()@%&]).{6,16}$/g;
   if(a.test(form.password.value)==false)
   {
    alert("It Must Contain One Alpha one Numeric & a Special Character");
    form.password.focus();
    return false;
...
var pass2=form.cpassword.value;
...
if(password.value != cpassword.value)
{
  alert("Do not Matching");
   ...
   {
   alert ( "Please Select whether ACTIVE/DISABLE" );
   return false;
   }  
   return true; 
}