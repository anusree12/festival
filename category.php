						...
						<div class="card">
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="cat_insert.php">
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Category</label>
													<input type="text" id="" class="form-control" placeholder="Category" name="category" autocomplete="off" required>
													</div>
												</div>
												<div class="col-md-12">
												<div class="form-group">
													...
													if($result->num_rows>0)
														...
														<thead>
															<tr role='row'>
																...
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 263px;'>Category</th>
