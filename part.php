					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Part Registration</h4>
													...
													if($result->num_rows>0)
														...
														<thead>
															<tr role='row'>
																...
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 263px;'>Part</th>
														...
														<tbody>
															...
															<td class='sorting_1'>".$row['id']."</td>
																<td class='sorting_1'>".$row['parts']."</td>
