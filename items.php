	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Festivel Items</h2>
			</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Items</h4>
							...
							<div class="card-body collapse in">
								<div class="card-block">
									<form class="form" method="post" action="item_insert.php" >
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Name Of Item</label>
													<input type="text" id="" class="form-control" placeholder="Items" name="items" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Programme</label>
													<input type="text" id="" class="form-control" placeholder="Programme" name="program" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Part</label>
													<input type="text" id="" class="form-control" placeholder="Part" name="part" autocomplete="off">
													</div>
												</div>
												<div class="col-md-12">
												<div class="form-group">
													...
													if($result->num_rows>0)
														...
														<thead>
															<tr role='row'>
																...
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 400px;'>Item Name</th>
																
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 300px;'>Part</th>

																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Position: activate to sort column ascending' style='width: 300px;'>Programme</th>
														...
														<tbody>
															...
															<td class='sorting_1'>".$row['id']."</td>
																<td class='sorting_1'>".$row['items']."</td>
																<td class='sorting_1'>".$row['part']."</td>
																...
																<a id=".$row['id']." onclick='sure(this.id);'><span style='color:#fff;' class='btn btn-danger glyphicon glyphicon-trash' title='Delete post'>
