			...
			<div class="navbar-container content container-fluid">
				<div id="navbar-mobile" class="collapse navbar-toggleable-sm">
					...
					<ul class="nav navbar-nav float-xs-right">
						<li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="images/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name" style="color:white">Masters</span></a>
		...
		<div class="content-body">
			...
			<section id="basic-form-layouts">
				<div class="row match-height">
					...
					<div id="mstr">
						<iframe src="centerpic1.php"  frameborder="0" width="1250" height="500" name="frm" ></iframe>
...
<p class="clearfix text-muted text-sm-center mb-0 px-2">
	<span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 201 9<a href="" target="_blank" class="text-bold-700 black footer_logo">Gokulolsavam </span>
